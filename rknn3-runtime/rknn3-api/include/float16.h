...
#ifndef __RKNN3_FLOAT16_H_
#define __RKNN3_FLOAT16_H_
...
static inline float   fp16_to_fp32(float16 data) { return (float)data; }
static inline float16 fp32_to_fp16(float data) { return (float16)(data); }
