...
import ctypes
import numpy as np
from rknn3lite.api import RKNN3Lite, RKLLMCallback, LLMResultCallback, LLMTokenizerCallback, LLMGetEmbedCallback, RKNN3Image, Float16, dump_tensor_attr


RKNN_LLM_MODEL = '/userdata/model/Qwen2.5-VL-3B-llm.rknn'
RKNN_VISION_MODEL = '/userdata/model/Qwen2.5-VL-3B-vision.rknn'
EMBED_PATH = '/userdata/model/Qwen2.5-VL-3B-llm.embed.bin'
TOKENIZER_PATH = './qwen2_5_VL_3B'


VOCAB_SIZE = 151936 # 可从config.json查询 vocab_size 字段
